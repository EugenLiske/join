...
export function getSubtaskTemplate(input){
    return `<!-- normal -->
            <li id="subtask_element_${nextSubtaskId}" class="subtask_bulletpoint">
                <span id="subtask_${nextSubtaskId}">${input}</span>
                <div class="subtask_icon_wrapper pad_8">
                    <svg id="delete_subtask_${nextSubtaskId}" height="16" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg id="open_edit_subtask_${nextSubtaskId}" height="16" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div id="edit_mode_${nextSubtaskId}" class="edit_subtask edit_overlay d_none">
                    ...
                    <div class="subtask_icon_wrapper pad_8">
                        <svg id="delete_edit_subtask_${nextSubtaskId}" height="16" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg id="save_edit_subtask_${nextSubtaskId}" width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function getAssignedToTemplate(color, initials){
...
export function getListElementTemplate2(selectedDesignClass, personIdx, personkey, checked){
    return `<li id="${personIdx}" class="${selectedDesignClass}">
                <div class="person_info">
